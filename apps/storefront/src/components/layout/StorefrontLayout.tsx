    ...
    <div className="storefront-shell">
      ...
      <footer className="storefront-footer">
        <div className="footer-newsletter">
          <p className="eyebrow">Bản tin HORIZ</p><h2>Nhận tin mới từ HORIZ</h2><p className="footer-newsletter__description">Sản phẩm mới, bộ sưu tập và ưu đãi được gửi vừa đủ.</p>
          <form className="newsletter-form" onSubmit={(event) => void subscribe(event)}><label className="sr-only" htmlFor="newsletter-email">Email nhận bản tin</label><input id="newsletter-email" onChange={(event) => setNewsletterEmail(event.target.value)} placeholder="Email của bạn" required type="email" value={newsletterEmail} /><button className="button button--light" type="submit">Đăng ký</button></form>
