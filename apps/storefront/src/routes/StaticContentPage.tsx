...
const pages: Record<string, Page> = {
  ...
  privacy: { eyebrow: 'Pháp lý', title: 'Chính sách quyền riêng tư', intro: 'HORIZ chỉ thu thập dữ liệu cần thiết để xử lý đơn hàng, hỗ trợ khách hàng và cải thiện dịch vụ.', sections: [['Dữ liệu sử dụng', 'Thông tin liên hệ, địa chỉ và lịch sử đơn hàng được dùng để hoàn tất giao dịch và hỗ trợ sau bán.'], ['Bảo mật', 'Quyền truy cập dữ liệu được giới hạn theo vai trò và các thao tác quản trị được ghi nhận.'], ['Quyền của bạn', 'Bạn có thể yêu cầu xem, sửa hoặc xóa thông tin cá nhân theo quy định áp dụng.']] },
  terms: { eyebrow: 'Pháp lý', title: 'Điều khoản sử dụng', intro: 'Khi đặt hàng, bạn xác nhận thông tin cung cấp là chính xác và đồng ý với chính sách bán hàng hiện hành.', sections: [['Giá và tồn kho', 'Giá, ưu đãi và tồn kho được xác nhận lại tại thời điểm đặt hàng.'], ['Thanh toán COD', 'Khách hàng thanh toán cho đơn vị vận chuyển khi nhận hàng.'], ['Giới hạn trách nhiệm', 'HORIZ xử lý khiếu nại theo pháp luật Việt Nam và chính sách công bố tại thời điểm mua.']] },
}
